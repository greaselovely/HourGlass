...
HOME = Path.home()
VLA_BASE = os.path.join(HOME, "NGVLA")
...
video_path = os.path.join(VIDEO_FOLDER,f"NGVLA.{today_short_date}.mp4")

IMAGE_URL = "https://public.nrao.edu/wp-content/uploads/temp/ngvla_webcam_temp.jpg"
WEBPAGE = "https://public.nrao.edu/ngvla-webcam/"
...
class ImageDownloader:
    ...
    def download_image(self, session, IMAGE_URL):
        ...
        FileName = f'ngvla.{today_short_date}.{today_short_time}.jpg'
